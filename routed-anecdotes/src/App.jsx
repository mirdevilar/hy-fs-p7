...
const About = () => (
  <div>
    ...
    <em>
      ...
      (If an anecdote is a story with a point, how come an argument is said to be anecdotal when it relies on an intrascendent event, meaning that it's not enough to support a point? Never trust Wikipedia! :P)
    </em>
...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/')
    props.setNotification(`Created blog "${content}"`)
    setTimeout(() => {
...
const App = () => {
  ...
  const anecdoteToRender = anecdoteMatch
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/anecdotes/:id" element={<Anecdote anecdote={anecdoteToRender} />} />
      </Routes>
